...
export default function InterventionCard({ intervention, onDismiss, onAccept }: InterventionCardProps) {
  ...
  const handleSubmitRating = async () => {
    ...
    try {
      ...
      await axios.post(
        `http://localhost:3001/api/ai/acknowledge/${intervention.id}`,
  ...
  const guidanceParagraphs = intervention.guidance_text.split('\n\n').filter(Boolean)
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1rem' }}>
        ...
        <div>
          <div style={{ fontWeight: 600, color: '#1F3864', fontSize: '0.95rem' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '10px', fontWeight: 600, color: '#888', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '5px' }}>
