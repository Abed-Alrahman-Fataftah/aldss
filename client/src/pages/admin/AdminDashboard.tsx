...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "participants" | "activity"
  >("overview");
  ...
  useEffect(() => {
    Promise.all([adminAPI.getOverview(), adminAPI.getParticipants()])
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f0f2f5" }}>
      ...
      <div
        style={{ maxWidth: "1100px", margin: "0 auto", padding: "1.5rem 2rem" }}
      >
        {loading && (
          ...
          <div>
            ...
            >
              <StatCard
                ...
                sub={`${overview.participants.active} active`}
              />
              <StatCard
                label="Control group"
                value={overview.participants.control}
                sub="No AI guidance"
              />
              <StatCard
                label="Intervention group"
                value={overview.participants.intervention}
                sub="Receiving AI guidance"
              />
              <StatCard
                label="At risk"
                value={atRiskCount}
                sub="5+ days inactive"
                color={atRiskCount > 0 ? "#e74c3c" : "#27ae60"}
              />
            </div>
            ...
            >
              <StatCard
                ...
                value={overview.activity.totalSessions}
                sub="All time"
              />
              <StatCard
                label="Sessions this week"
                value={overview.activity.recentSessions}
                sub="Last 7 days"
              />
              <StatCard
              ...
              <StatCard
                ...
                value={overview.activity.totalSurveys}
                sub="All types"
              />
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        <div
                          style={{
                            ...
                            background: "#2E75B6",
                            borderRadius: "4px",
                            width: `${(overview.sentiment.avgMotivation || 0) * 10}%`,
                          }}
                        />
                      </div>
                      <div
                      ...
                      >
                        From {overview.sentiment.surveyCount} survey
                        {overview.sentiment.surveyCount !== 1 ? "s" : ""} this
                        week
                      </div>
                    </div>
                  </div>
                      ...
                      >
                        <div
                          style={{
                            ...
                            background: "#27ae60",
                            borderRadius: "4px",
                            width: `${(overview.sentiment.avgProgress || 0) * 10}%`,
                          }}
                        />
                      </div>
                    </div>
          ...
          <div>
            {atRiskCount > 0 && (
              ...
              >
                ...
                >
                  {atRiskCount} participant{atRiskCount !== 1 ? "s" : ""} at
                  risk of dropping out
                </div>
                <div style={{ fontSize: "0.875rem", color: "#c0392b" }}>
                  These participants have not logged in for 5 or more days.
                  Consider sending a re-engagement message.
                </div>
              </div>
            )}
            ...
            >
                  ...
                  {participants.map((p, i) => (
                    ...
                    >
                      <td style={{ padding: "0.875rem 1rem" }}>
                        <div style={{ fontWeight: 500, color: "#1F3864" }}>
                          {p.fullName}
                        </div>
                        <div style={{ fontSize: "0.8rem", color: "#888" }}>
                          {p.fieldOfStudy || "Not specified"}
                        </div>
                      </td>
                      <td style={{ padding: "0.875rem 1rem" }}>
                        <span
                      ...
                      >
                        {p.lastSurveyWeek > 0
                          ? `Week ${p.lastSurveyWeek}`
                          : "None yet"}
                      </td>
                      <td
                        style={{
                          padding: "0.875rem 1rem",
                          color: p.atRisk ? "#e74c3c" : "#444",
                        }}
                      >
              ...
              {participants.length === 0 && (
                ...
                >
                  No participants enrolled yet. Share your registration link to
                  get started.
                </div>
              )}
            </div>
                ...
                >
                  {activity.map((event) => (
                    ...
                    >
                      ...
                      <div
                        style={{ flex: 1, fontSize: "0.875rem", color: "#444" }}
                      >
                        {event.user?.fullName}
                        <span
                          style={{
