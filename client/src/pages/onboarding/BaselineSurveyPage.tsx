...
export default function BaselineSurveyPage() {
  ...
  const handleSubmit = async () => {
    if (
      ...
      !form.selfEfficacyScore ||
      !form.consistencyScore
    ) {
  ...
  return (
    <div className="page">
      <div className="card card-wide">
        ...
        <p>
          Help us understand your starting point. This takes about 3 minutes and
        ...
        <div className="form-group">
          <label>
            What is your main learning goal for the next 2 months? *
          </label>
          <textarea
        ...
        <div className="form-group">
          <label>
            How motivated are you to achieve this goal right now? *{" "}
            <span className="text-muted">(1 = not at all, 10 = extremely)</span>
          </label>
          <ScaleInput
        ...
        <div className="form-group mt-2">
          <label>
            How confident are you in your ability to learn consistently? *{" "}
            <span className="text-muted">
              (1 = not confident, 10 = very confident)
            </span>
          </label>
          <ScaleInput
            value={form.selfEfficacyScore}
            onChange={(v) => update("selfEfficacyScore", v)}
          />
        </div>

        <div className="form-group mt-2">
          <label>
            How consistent have you been with learning in the past 3 months? *{" "}
            <span className="text-muted">
              (1 = very inconsistent, 10 = very consistent)
            </span>
          </label>
          <ScaleInput
            value={form.consistencyScore}
            onChange={(v) => update("consistencyScore", v)}
          />
        </div>

        <div className="form-group mt-2">
          <label>
            What has been your biggest challenge with learning consistency?
          </label>
          <select
          ...
          >
            ...
            <option value="too_many_choices">
              Too many options — hard to choose what to study
            </option>
        ...
        <div className="form-group">
          <label>
            How much prior experience do you have with online self-directed
            learning?
          </label>
          <select
          ...
          >
            ...
            <option value="experienced">
              Experienced — I learn online regularly
            </option>
          </select>
        </div>
